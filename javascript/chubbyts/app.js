...
const app = (0, application_1.createApplication)([
  ...
  (0, route_matcher_middleware_1.createRouteMatcherMiddleware)(
    (0, path_to_regexp_router_1.createPathToRegexpRouteMatcher)(
      (0, routes_by_name_1.createRoutesByName)([
...
const nodeToServerRequestFactory = (0, node_http_1.createNodeToServerRequestFactory)(
  (0, message_factory_1.createUriFactory)(),
  (0, message_factory_1.createServerRequestFactory)(),
  (0, message_factory_1.createStreamFromResourceFactory)(),
);
