...
# =============================================================================
# Phoenix Configuration - Security & Performance
# =============================================================================

# JSON library for Phoenix
config :phoenix, :json_library, Jason

# Endpoint configuration with production settings
config :server, Server.Endpoint,
  ...
  debug: Mix.env() != :prod,
  # Security: Code reloading disabled in production
  code_reloader: Mix.env() != :prod,
  # Performance: Secret key base from environment
  secret_key_base: System.get_env("SECRET_KEY_BASE") || "change-me-in-production",
  # Security: Disable HTTPS redirects in development
  https: [
    port: 443,
    cipher_suite: :strong,
...
# =============================================================================
# Bandit Server Configuration - Security & Performance
# =============================================================================
