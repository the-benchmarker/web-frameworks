...
// BenchmarkServer represents the vanilla io_uring benchmark server
struct BenchmarkServer {
	port int
	server &http_server.Server
}

// new_benchmark_server creates a new vanilla io_uring benchmark server instance
...
fn main() {
	...
	log.info('Starting vanilla io_uring benchmark server on port ${port}')
