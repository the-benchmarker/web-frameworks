...
find $1 -mindepth 2 -type f -name config.yaml | grep -vE "yada|grip|hunt|chubbyts|chubbyts-uwebsockets|nestjs-fastify|scorper|comet|hamlet|ice|phalcon|argan" > /tmp/list.txt
