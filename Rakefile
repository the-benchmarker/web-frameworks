...
namespace :ci do
  task :config do
    ...
    config = { version: 'v1.0', name: 'Benchmarking suite', execution_time_limit: { hours: 3 }, agent: { machine: { type: 'e1-standard-2' }, containers: [{ name: 'main', image: 'crystallang/crystal:latest' }] }, blocks: blocks }
