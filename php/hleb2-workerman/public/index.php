...
/**
 * HLEB2 Workerman Framework Benchmark Server Entry Point
 * 
 * Production-grade benchmark server using HLEB2 with Workerman.
...
$server->name = 'HLEB2 Workerman Benchmark Server';
...
$server->onMessage = function (TcpConnection $connection, $request) use ($framework) {
    try {
        ...
        addSecurityHeaders($res->getHeaders());
        ...
        $connection->send(new Response(500, $headers, $body));
    }
};
