...
/**
 * ChubbyPHP Workerman Framework Benchmark Server Entry Point
 * 
 * Production-grade benchmark server using ChubbyPHP with Workerman.
...
define('APP_NAME', 'ChubbyPHP Workerman Benchmark Server');
