...
/**
 * Production-grade Webman Framework Benchmark Server
 * 
 * A high-performance, production-ready benchmark server using Webman framework.
...
define('APP_NAME', 'Webman Benchmark Server');
...
set_error_handler(function ($code, $message, $file, $line) {
    ...
    addSecurityHeaders();
    // For workerman-based frameworks, we can't exit, but we can log
});
