...
/**
 * Production-grade APlus App Framework Benchmark Server
 * 
 * A high-performance, production-ready benchmark server using APlus App framework.
...
define('APP_NAME', 'APlus App Benchmark Server');
