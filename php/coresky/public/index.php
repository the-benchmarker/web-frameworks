...
/**
 * Production-grade CoreSky Framework Benchmark Server
 * 
 * A high-performance, production-ready benchmark server using CoreSky framework.
...
define('APP_NAME', 'CoreSky Benchmark Server');
