...
/**
 * Production-grade MixPHP Framework Benchmark Server
 * 
 * A high-performance, production-ready benchmark server using MixPHP framework.
...
define('APP_NAME', 'MixPHP Benchmark Server');
