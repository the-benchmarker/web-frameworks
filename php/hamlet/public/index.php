...
/**
 * Production-grade Hamlet Framework Benchmark Server
 * 
 * A high-performance, production-ready benchmark server using Hamlet framework.
...
define('APP_NAME', 'Hamlet Benchmark Server');
