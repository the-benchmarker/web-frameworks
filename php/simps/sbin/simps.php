...
/**
 * Production-grade Simps Framework Benchmark Server
 * 
 * A high-performance, production-ready benchmark server using Simps framework.
...
define('APP_NAME', 'Simps Benchmark Server');
