...
/**
 * Production-grade Mezzio Framework Benchmark Server
 * 
 * A high-performance, production-ready benchmark server using Mezzio framework.
...
define('APP_NAME', 'Mezzio Benchmark Server');
