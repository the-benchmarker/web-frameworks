    ...
    definition = {
      ...
      blocks: [{
        ...
        'task' => {
          'jobs' => [{
            'name' => 'setup',
            'commands' => ['checkout', 'cache store $SEMAPHORE_GIT_SHA .', 'sem-version ruby 3.0.0', 'sudo apt-get update',
